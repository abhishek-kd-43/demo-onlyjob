document.addEventListener("DOMContentLoaded", () => {
    fetch('data.json')
      ...
      .then(data => {
        ...
        // -------------------------
        const renderList = (containerId, items, colorVar) => {
        ...
        renderList('live-latest-jobs', data.latest_jobs, '--green');
        renderList('live-admit-cards', data.admit_cards, '--purple');
        renderList('live-results', data.results, '--red');
